...
const AiAssistant = () => {
  ...
  return (
    <div className="py-2">
      <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl border border-zinc-200 overflow-hidden flex flex-col h-[85vh]">
        {}
        <div className="bg-slate-900 p-6 text-white flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-1.5 bg-yellow-500/10 text-yellow-400 border border-zinc-200 px-3 py-1 rounded-full text-xs font-semibold">
            <AlertTriangle className="w-3.5 h-3.5" /> General Guidance Only
          </div>
        </div>

        {}
        <div className="bg-amber-50 text-amber-900 px-6 py-3 border-b border-zinc-200 flex items-center gap-2 text-xs sm:text-sm font-medium">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              <div
                className={`w-9 h-9 rounded-full flex items-center justify-center shrink-0 border ${
                  msg.sender === "user"
                    ...
                    : "bg-teal-50 text-teal-600 border-zinc-200"
                }`}
              >
              ...
              <div
                className={`rounded-2xl px-5 py-3.5 text-sm leading-relaxed whitespace-pre-wrap ${
                  msg.sender === "user"
                    ...
                    : "bg-slate-50 border border-zinc-200 text-slate-800 rounded-tl-none"
                }`}
              >
          ...
          {loading && (
            <div className="flex items-start gap-3 max-w-[85%]">
              <div className="w-9 h-9 rounded-full bg-teal-50 border border-zinc-200 flex items-center justify-center shrink-0 text-teal-600">
                <Stethoscope className="w-4 h-4" />
              </div>
              <div className="bg-slate-50 border border-zinc-200 rounded-2xl rounded-tl-none px-5 py-4 flex items-center space-x-1.5">
        ...
        <div className="p-4 border-t border-zinc-200 bg-white flex items-center gap-3">
          <input
            ...
            className="flex-1 bg-slate-50 border border-zinc-200 hover:border-zinc-800 focus:border-zinc-800 outline-none rounded-xl px-5 py-3 text-sm text-slate-700 transition-colors"
            value={input}
