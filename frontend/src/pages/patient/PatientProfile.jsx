...
const PatientProfile = () => {
  ...
  if (error) {
    return (
      <div className="h-[50vh] flex items-center justify-center">
        <div className="bg-white p-8 rounded-xl shadow-sm border border-zinc-200 border-l-4 border-zinc-200 max-w-md text-center">
            ...
            <div className="bg-white border border-zinc-200 rounded-xl p-6 shadow-sm flex flex-col items-center text-center">
              ...
              <div className="w-full border-t border-zinc-200 mt-6 pt-5 space-y-3">
                <div className="flex items-center justify-between text-xs text-slate-500">
                  ...
                  <span className="bg-slate-100 text-slate-700 px-2 py-0.5 font-bold uppercase tracking-wider rounded border border-zinc-200 text-[9px]">
                    {profile.role}
                  </span>
                </div>
                <div className="flex items-center justify-between text-xs text-slate-500">
              ...
              <div className="flex justify-between items-center border-b border-zinc-200 pb-4 mb-5">
                ...
                {!isEditingPersonal && (
                  <button
                    ...
                    className="text-xs font-semibold text-teal-600 hover:text-teal-700 border border-zinc-200 hover:bg-slate-50 px-3 py-1.5 rounded-lg transition-colors cursor-pointer"
                  >
                    Edit
                  </button>
                )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-zinc-200 rounded-lg text-xs focus:outline-none focus:ring-1 focus:ring-zinc-800 focus:border-zinc-800 transition-shadow"
                        placeholder="Name"
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        readOnly
                        className="w-full px-3 py-2 border border-zinc-200 rounded-lg text-xs bg-slate-50 text-slate-500 cursor-not-allowed outline-none"
                      />
                    </div>
                  </div>
                    ...
                    <div className="mt-2 flex flex-wrap gap-1.5">
                      {patientProfile?.medicalHistory?.length > 0 ? (
                        patientProfile.medicalHistory.map((item, idx) => (
                          <span
                            key={idx}
                            className="bg-slate-50 text-slate-600 border border-zinc-200 px-2 py-0.5 text-xs font-semibold rounded"
                          >
                            {item}
                          </span>
                        ))
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 border border-zinc-200 rounded-lg text-xs focus:outline-none focus:ring-1 focus:ring-zinc-800 focus:border-zinc-800 bg-white transition-shadow"
                      >
